    ...
    return (
        <div className="profile-top bg-primary p-2">
          <img
            ...
            alt=""
          />
          <h1 className="large">Name is Roland</h1>
    <p className="lead">Owner of Fantastic idea</p>
    <p>This will take 2 weeks</p>
          <div className="icons my-1">
              {
                  ( <>
                    <span>This is my website</span> 
                      <a href="#!" target='_blank' rel="noopener noreferrer">globe-icon</a>
                      </>
                  )
              }
              { (
                   <a href="#" target='_blank' rel="noopener noreferrer">twitter icon</a>
              ) }
